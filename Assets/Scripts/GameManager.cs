...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("Number of seconds to sleep the game before jump to Game Over.")]
    float gameOverSleep;
    ...
    private void Start()
    {
        ...
        wheel.eulerAngles = new Vector3(0.0F, 0.0F, -_startAngle);
    }
    ...
    private void Update()
    {
        ...
        bool hasReachFinalAngle = wheel.eulerAngles.z == _finalAngle;

        if (isTimeout || hasReachFinalAngle)
        {
            _currentSpinningTime = maxSpinningTime;
            _startAngle = _finalAngle % 360;
            wheel.eulerAngles = new Vector3(0.0F, 0.0F, _finalAngle);
        ...
        wheel.eulerAngles = new Vector3(0.0F, 0.0F, angle);
